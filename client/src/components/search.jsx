...
import 'tw-elements';
import searchBackground from "../assests/images/searchBackground.jpg";


function Search() {
    return( 
        <div className="search-page bg-local bg-no-repeat bg-cover" style={{backgroundImage:`url(${searchBackground})`}}>
            <div className="flex justify-center p-20">
                <div className="m-10">
                    <h1 className="text-center font-bold text-white text-3xl m-10 font-mono">Search For Your Sports Product</h1>
