    ...
    <div className="footer-page">
        ...
        <div class="mx-6 py-10 text-center md:text-left">
            ...
            <div class="">
                ...
                <p class="mb-4">
                <a href="#!" class="text-gray-600">Sports Equipments</a>
                </p>
                <p class="mb-4">
                <a href="#!" class="text-gray-600">Sports Jersy</a>
                </p>
                <p class="mb-4">
                <a href="#!" class="text-gray-600">GYM equipments</a>
                </p>
                <p>
                <a href="#!" class="text-gray-600">Sports Shopes</a>
                </p>
            </div>
            <div class="">
                <h6 class="uppercase font-semibold mb-4 flex justify-center md:justify-start">
        ...
        <div class="text-center p-6 bg-gray-200">
            ...
            <a class="text-gray-600 font-semibold" href="https://tailwind-elements.com/"> E-Sports Shop</a>
        </div>
        </footer>
    </div>
    )
